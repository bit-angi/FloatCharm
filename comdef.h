...
enum class MOUSE_EVENT_TYPE {NONE,/*RUNTIME_SELECT,*/CREATING_CNANGE_SIZE,RUNTIME_CHANGE_SIZE,RUNTIME_CREATE_MAGPOINT,RUNTIME_CHANGE_POS,MULTI_SELECTION} ;
...
enum class PaintChartType{NONE,RECT,DIAMOND,ROUNDRECT,ELLIPSE,LINE,TRAPEZOID,PARALLELOGRAM,TRIANGLE,CIRCLE,CAPSULE,SUBFLORT,IMAGE};
