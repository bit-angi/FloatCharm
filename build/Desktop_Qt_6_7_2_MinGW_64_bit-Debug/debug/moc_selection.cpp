...
struct qt_meta_stringdata_CLASSSelectionENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSelectionENDCLASS = QtMocHelpers::stringData(
    "Selection"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSelectionENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Selection::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSelectionENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSelectionENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSelectionENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Selection::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSelectionENDCLASS.stringdata0))
